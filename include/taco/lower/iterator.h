...
public:
  ...
  ir::Stmt getAppendEdges(const ir::Expr& pPrev, const ir::Expr& pBegin, 
      const ir::Expr& pEnd, const bool isCompound=false) const;
...
private:
  ...
  void setWindowBounds(ir::Expr lo, ir::Expr off, ir::Expr hi, ir::Expr stride);
