...
public:
  ...
  /// Set the tensor's value to be scalar.
  void setScalar();
...
public:
  ...
  //template <typename... IndexVars>
  //Access operator()(const AffineIndexVar& first, const IndexVars&... indices);
...
// Jaeyeon : Adding the AffineIndexVar template
//template <typename CType>
//template <typename... IndexVars>
//Access Tensor<CType>::operator()(const AffineIndexVar& first, const IndexVars&... indices) {
//  return this->_access_wrapper(first, indices...);
//}
